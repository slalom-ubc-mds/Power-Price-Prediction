...
import sys
sys.path.append('../')
from src.deployed_scripts.pipeline_helper import *
...
def test_generate_sentence_dataframe():
    ...
    assert "The average power price of the past month is $" in output['Sentence'].iloc[0]

def test_generate_tableau_required_dataframe():
    # Prepare a sample DataFrame for testing
    data = {
        'predictions': [74.380361, 62.697907, 65.038264, 57.072062, 58.505975, 73.002258, 83.119340, 107.230484, 90.060522, 79.584282, 77.160666, 72.709050],
        'lower_bound': [58.722277, 50.048370, 51.530106, 46.288219, 48.008368, 45.724813, 47.939297, 47.148052, 46.426701, 44.567575, 43.531427, 42.791301],
        'upper_bound': [174.589122, 203.500652, 238.746433, 181.062615, 241.152583, 271.126336, 305.724652, 379.961233, 372.202719, 348.386136, 483.350045, 384.818586]
    }
