...
def test_preprocess_data():
    ...
    features_file_path = os.path.join(os.getcwd(), "data", "processed", "complete_data", "features.csv")
    target_file_path = os.path.join(os.getcwd(), "data", "processed", "complete_data", "target.csv")
    assert os.path.exists(features_file_path)
    assert os.path.exists(target_file_path)

    # Check if the train-test split data files are created
    train_features_file_path = os.path.join(os.getcwd(), "data", "processed", "train", "X_train.csv")
    train_target_file_path = os.path.join(os.getcwd(), "data", "processed", "train", "y_train.csv")
    test_features_file_path = os.path.join(os.getcwd(), "data", "processed", "test", "X_test.csv")
    test_target_file_path = os.path.join(os.getcwd(), "data", "processed", "test", "y_test.csv")
    assert os.path.exists(train_features_file_path)
    assert os.path.exists(train_target_file_path)
    assert os.path.exists(test_features_file_path)
    assert os.path.exists(test_target_file_path)
